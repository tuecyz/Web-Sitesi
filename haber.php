...
$id =$_GET['getir'];
$query = $db->query("SELECT * FROM haberler WHERE id = '{$id}'")->fetch(PDO::FETCH_ASSOC);
...
<body class="host_version"> 
	  ...
	  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header tit-up">
				...
				<h4 class="modal-title">Giriş Yap Veya Kayıt Ol</h4>
			</div>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item  active"><a class="nav-link" href="haberler.php">Haberler</a></li>
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1><span class="m_1"><?=$query['ust_baslik']?></span></h1>
		</div>
	</div>
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img class="d-block w-100" src="images/haber-resmi1.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="images/haber-resmi2.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="images/haber-resmi3.jpg" alt="Third slide">
                        </div>
                      </div>
                      ...
                      <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
						...
						<div class="post-content">
							<div class="meta-info-blog">
								<span><i class="fa fa-calendar"></i> <a><?=$query['zaman']?></a> </span>
							</div>
							<div class="blog-title">
								<h1><a ><?=$query['ust_baslik']?></a></h1>
							</div>
							<div style="text-align: justify" class="blog-desc">
