				...
				<div class="row">
					...
					<div class="left_side">
						<div class="search-main">
							...
							<input type="text" name="search" placeholder="Etkinlik başlığı girin..">
							</form>
						</div>
						<?php
						include'baglan.php';
                             ...
                             foreach( $query as $row ){?>
                                  <div class="col-md-3 col-xs-12 col-sm-6">
                                    <div class="mainbox">
                                        ...
                                        <div class="imgbox">
                                            <a href="etkinlik.php?getir=<?=$row['id']?>"><img src="images/blog_1.jpg" alt=""></a>
                                        </div>
                                    ...
                                    <?php }?>
                                        ...
                                        <div class="righttext">
                                            <a href="a-etkinlik-duzenle.php?duzenle=<?=$row['id']?>">Düzenle</a>
