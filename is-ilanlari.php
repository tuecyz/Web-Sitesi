                    ...
                    <div class="course-item">
						<div class="course-br">
							<div class="course-title">
								<h2><a href="is-ilani.php?getir=<?=$row['id']?>" title=""><?php echo  $row['ust_baslik'] ?></a></h2>
							</div>
						...
						<div class="course-meta-bot" style="margin-bottom: 20px">
							<ul>
								<li><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo  $row['zaman'] ?></li>
								<li><i class="fa fa-users" aria-hidden="true"></i> <?php echo  $row['basvuran_sayisi'] ?> Kişi Bu İlana Başvurdu</li>
