                ...
                <div class="col-lg-4 col-md-6 col-12" style="margin-bottom: 20px">
                    <div class="blog-item">
						<div class="image-blog">
							<a href="haber.php?getir=<?=$row['id']?>"><img src="images/1.jpg" alt="" class="img-fluid"></a>
						</div>
						<div class="meta-info-blog">
							<span><i class="fa fa-calendar"></i> <a><?php echo  $row['zaman'] ?></a> </span>

						</div>
						<div class="blog-title">
							<h2><a href="#" title=""><?php echo  $row['ust_baslik'] ?></a></h2>
						</div>
						<div class="blog-button">
							<a class="hover-btn-new orange" href="haber.php?getir=<?=$row['id']?>"><span>Daha Fazla<span></a>
						</div>
					</div>
                </div><!-- end col -->
                <?php }
