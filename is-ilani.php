...
<body class="host_version"> 
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="haberler.php">Haberler</a></li>
						 <li class="nav-item  active"><a class="nav-link" href="is-ilanlari.php">İş İlanları</a></li>
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1><?=$query['ust_baslik']?><span class="m_1"><?=$query['sirket_adi']?></span></h1>
		</div>
	</div>
                    ...
                    <div class="blog-item">
						<div class="post-content">
							<div class="meta-info-blog">
								...
								<span><i class="fa fa-users" aria-hidden="true"></i><a> <?=$query['basvuran_sayisi']?> Başvuran</a></span>
							...
							<div class="text-right">
                                <a>İşe başvurmak için giriş yapın</a>
							    <button style="text-align: right" type="button" disabled="disabled" class="btn btn-light btn-radius btn-brd grd1">
								İşe Başvur
								</button>	
