				...
				<div class="row">
					...
					<div class="left_side">
						<div class="search-main">
							...
							<input type="text" name="search" placeholder="İş ilanı başlığı girin..">
							</form>
						</div>
						<!---çekilen veri-->
						<?php  
						...
						$query = $db->query("SELECT * FROM is_ilanlari", PDO::FETCH_ASSOC);
                        if ( $query->rowCount() ){
                             foreach($query as $row ){?>
                                  <div class="col-md-3 col-xs-12 col-sm-6">
                                    <div class="mainbox" style="min-height:200px">
                                    <div class="icKutu" style="margin-top:20px">
                                        <div class="lefttext" style="min-height: 80px;">
                                            <h3 style="color:#0e76a8"><?php echo  $row['ust_baslik'] ?></h3>
                                          <?php echo  $row['sirket_adi'] ?>
                                    ...
                                    <?php }?>
                                        ...
                                        <div class="righttext" style="margin-top: 130px;">
                                            <a href="a-is-ilani-duzenle.php?duzenle=<?=$row['id']?>">Düzenle</a>
