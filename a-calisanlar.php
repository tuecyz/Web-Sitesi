				...
				<div class="row">
					...
					<div class="left_side">
						<div class="search-main">
							...
							<input type="text" name="search" placeholder="Çalışan ismi girin..">
							</form>
							<br>
						</div>
						 <?php
						include'baglan.php';
						$query = $db->query("SELECT * FROM calisanlar", PDO::FETCH_ASSOC);
                        if ( $query->rowCount() ){
                            ...
                            <div class="mainbox">
                                ...
                                <div class="righttext">
                                    <a href="a-calisanlar-duzenle.php?duzenle=<?=$row['id']?>">Düzenle</a>
