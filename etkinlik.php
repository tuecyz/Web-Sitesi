...
<body class="host_version"> 
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1><?=$query['ust_baslik']?><span class="m_1"><?=$query['konum']?></span></h1>
		</div>
	</div>
                    ...
                    <div class="blog-item">
						...
						<div class="post-content">
							<div class="meta-info-blog">
								<span><i class="fa fa-calendar"></i> <a><?=$query['etkinlik_tarihi']?></a> </span>
								<span><i class="fa fa-users" aria-hidden="true"></i><a> 56 Katılımcı</a></span>
							</div>
							...
							<div class="text-right">
                                <a>Etkinliğe katılmak için giriş yapın</a>
